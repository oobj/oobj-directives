...
angular.module('oobj-directives.templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("oobj-container/oobj-container.html",
    "<div><div class=row ng-if=\"title != undefined\"><div class=col-lg-12><h5 class=page-header style=\"padding-bottom: 5px; border-bottom: 0px solid\"><span ng-bind=title></span> <i class=\"fa fa-info-circle\"></i></h5></div></div><div class=row><div ng-transclude></div></div></div>");
  ...
  $templateCache.put("oobj-multiselect/oobj-multiselect.html",
    "<div ng-class=colspan class=\"form-group form-group-{{inputSize}}\"><label class=control-label ng-show=\"showLabel != false && label != undefined\"><strong><span ng-bind=label></span></strong> <span class=text-danger ng-show=ngRequired>*</span></label><div class=input-group><select id={{id}} class=\"selectpicker form-control\" title=\"\" data-width=auto ng-model=ngModel ng-required=ngRequired multiple ng-cloak></select></div></div>");
