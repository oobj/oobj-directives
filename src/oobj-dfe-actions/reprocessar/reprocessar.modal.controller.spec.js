/**
 * Teste do controlador do modal: reprocessar.modal.controller.js.
 *
...
(function() {
    ...
    describe('Teste do controlador do modal: reprocessar.modal.controller.js', function() {
        var $controller,
            ModalUtil,
            uibModalInstanceMock = {},
            selectedRows,
            ctrl,
            ReprocessarModalService,
            deferred,
            $scope;

        beforeEach(module('oobj-directives'));
        beforeEach(inject(function(_$controller_, _ModalUtil_, _ReprocessarModalService_, _$q_, _$rootScope_) {
            deferred = _$q_.defer();
            ...
            ctrl = $controller('ReprocessarModalController', {
                $uibModalInstance: uibModalInstanceMock,
                selectedRows: selectedRows,
                ModalUtil: ModalUtil,
                ReprocessarModalService: ReprocessarModalService
            });

            spyOn(ReprocessarModalService, 'reprocessar').and.returnValue(deferred.promise);
        }));
