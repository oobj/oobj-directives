/**
 * Teste do controlador do modal: retorno-eventos.modal.controller.js.
 *
 * Created by ATILLA on 18/02/2016.
 */
(function() {
    'use strict';

    describe('Teste do controlador do modal: retorno-eventos.modal.controller.js', function() {
        var $controller,
            ModalUtil,
            uibModalInstanceMock = {},
            selectedRows,
            ctrl,
            RetornoEventosModalService,
            deferred,
            $scope;

        beforeEach(module('oobj-directives'));
        beforeEach(inject(function(_$controller_, _ModalUtil_, _RetornoEventosModalService_, _$q_, _$rootScope_) {
            deferred = _$q_.defer();
            ...
            ctrl = $controller('RetornoEventosModalController', {
                $uibModalInstance: uibModalInstanceMock,
                selectedRows: selectedRows,
                ModalUtil: ModalUtil,
                RetornoEventosModalService: RetornoEventosModalService
            });

            spyOn(RetornoEventosModalService, 'gerarRetorno').and.returnValue(deferred.promise);
        }));
