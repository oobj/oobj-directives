/**
 * Teste do controlador baixar-danfe.modal.controller da directiva oobj-dfe-actions.
 *
...
(function() {
    ...
    describe('Teste do controlador da directiva: baixar-danfe.modal.controller.js', function() {
        var $controller,
            ModalUtilMock,
        ...
        beforeEach(inject(function(_$controller_, ModalUtil, _BaixarDANFeModalService_, _$q_, _$rootScope_) {
        ...
        function deveTerMesmosParamtros() {
            ...
            var ctrl = $controller('BaixarDANFeModalController', {
                $uibModalInstance: uibModalInstanceMock,
                ModalUtil: ModalUtil,
                BaixarDANFeModalService: BaixarDANFeModalService,
        ...
        function deveRealizarDownload() {
            ...
            spyOn(BaixarDANFeModalService, 'baixar').and.returnValue(deferred.promise);
            ...
            expect(BaixarDANFeModalService.baixar).toHaveBeenCalledWith([0, 1, 2]);
