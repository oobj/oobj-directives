/**
 * Teste unitário para evento do emitente modal.
 *
...
(function() {
    ...
    describe('Teste de Controller: EventoEmitenteModalController', function() {
        var $controller,
            $filter,
            $window,
            scope,
        ...
        it('ao clicar no botão saiba mais deve abrir em um nova janela', function() {
            ...
            var ctrl = $controller('EventoEmitenteModalController', {
