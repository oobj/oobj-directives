/**
 * Teste unitário para situação do documento na Sefaz modal.
 *
...
(function() {
    ...
    describe('Teste de Controller: SituacaoSefazModalController', function() {
        var $controller,
            $filter,
            $window,
            scope,
        ...
        it('ao clicar no botão saiba mais deve abrir em um nova janela', function() {
            ...
            var ctrl = $controller('SituacaoSefazModalController', {
