/**
 * Teste unitário para integridade do arquivo modal.
 *
...
(function() {
    ...
    describe('Teste de Controller: StatusIntegridadeArquivoModalController', function() {
        var $controller,
            $filter,
            $window,
            scope,
        ...
        it('ao clicar no botão saiba mais deve abrir em um nova janela', function() {
            ...
            var ctrl = $controller('StatusIntegridadeArquivoModalController', {
